...
export default function Location() {
  return (
    <section id="lokasi" className="bg-background py-20">
      <div className="mx-auto max-w-6xl px-4">
        <div className="mb-12 text-center">
          <p className="text-sm font-medium uppercase tracking-widest text-primary">Lokasi & Kontak</p>
          <h2 className="mt-2 font-heading text-3xl text-foreground sm:text-4xl">Temukan Kami</h2>
        </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Banjarsari, Kb. Dalem Kidul, Kec. Prambanan, Klaten, Jawa Tengah, Indonesia 57454</p>
                    <a
              ...
              <div className="rounded-2xl border border-border bg-card p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">Setiap Hari</p>
                    <p className="font-heading text-xl text-foreground">06:00 — 21:00 WIB</p>
                  </div>
                </div>
              </div>
            </StaggerItem>
              ...
              <div className="rounded-2xl border border-border bg-card p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-[11px] text-muted-foreground/60">Follow untuk info promo & event terbaru</p>
                  </div>
                </div>
              </div>
            </StaggerItem>
