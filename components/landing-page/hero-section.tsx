    ...
    <section ref={ref} id="hero" className="relative flex min-h-screen items-center justify-center overflow-hidden pt-16">
      ...
      >
        <motion.div
          ...
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#FF2A2A]/30 bg-primary/10 px-4 py-1.5"
        >
          <Trophy className="h-4 w-4 text-primary" />
          <span className="text-sm text-primary">Gym #1 Paling Direkomendasikan di Prambanan</span>
        </motion.div>

        <h1 className="font-heading text-5xl leading-tight text-foreground sm:text-7xl md:text-8xl">
          <span className="text-primary italic">LINEUP</span> GYM
        </h1>
        <h2 className="font-heading text-2xl text-muted-foreground sm:text-3xl">PRAMBANAN</h2>
        ...
        <div className="mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
          <a
            ...
            target="_blank"
            className="flex items-center gap-2 rounded-xl bg-primary px-8 py-3.5 text-base font-bold text-foreground shadow-lg shadow-[#FF2A2A]/20 transition-all hover:scale-105 hover:bg-[#CC2222]"
          >
            Gabung Sekarang <ChevronRight className="h-5 w-5" />
          </a>
          <button
            onClick={() => scrollTo('harga')}
            className="rounded-xl border border-[#333] px-8 py-3.5 text-base text-[#aaa] transition-colors hover:border-[#555] hover:text-foreground"
          >
            Lihat Harga
          </button>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-6">
          <a href="https://instagram.com/lineup.gym_" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 text-sm font-medium">
          ...
          <a href="https://www.tiktok.com/@lineupgymofficial" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors flex items-center gap-2 text-sm font-medium">
            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
