...
export default function PtPackages({ packages }: { packages: PackageData[] }) {
  ...
  return (
    <div>
      <h3 className="mb-4 text-sm font-medium uppercase tracking-wider text-muted-foreground">Paket Personal Trainer</h3>
      <StaggerContainer className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {packages.map((pkg) => (
          <StaggerItem key={pkg.id}>
            <div className="group h-full relative overflow-hidden rounded-2xl border border-blue-500/20 bg-card p-6 transition-all hover:border-blue-500/40">
              ...
              <div className="relative">
                ...
                <a
                  ...
                  target="_blank"
                  className="mt-5 flex w-full items-center justify-center gap-2 rounded-lg bg-blue-500/10 py-2.5 text-sm font-semibold text-blue-400 transition-colors hover:bg-blue-500 hover:text-foreground"
                >
