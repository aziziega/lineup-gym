...
export default function CtaFinal() {
  return (
    <section className="relative overflow-hidden py-20">
      ...
      >
        <h2 className="font-heading text-3xl text-foreground sm:text-5xl">
          Siap Mulai <span className="text-primary">Perjalanan Fitness</span> Kamu?
        </h2>
        ...
        <motion.a
          ...
          target="_blank"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-primary px-10 py-4 text-lg font-bold text-foreground shadow-[0_0_30px_-5px_rgba(255,42,42,0.4)] transition-colors hover:bg-[#CC2222]"
        >
