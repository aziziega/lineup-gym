...
export default function TodaySchedule() {
  ...
  return (
    <div className="rounded-xl border border-border/50 bg-card p-4">
      <h3 className="mb-3 text-sm font-semibold text-foreground">Jadwal Kelas Hari Ini</h3>

      {(!data || data.length === 0) ? (
        <p className="py-6 text-center text-sm text-muted-foreground/60">Tidak ada kelas hari ini</p>
      ) : (
