...
export function usePayments(refetchInterval?: number, enabled = true) {
  return useQuery({
    queryKey: ['payments'],
    queryFn: async () => {
...
export function useMonthlyRevenue(enabled = true) {
  return useQuery({
...
export function useCurrentMonthRevenue(enabled = true) {
  return useQuery({
